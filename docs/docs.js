...
},{"../../svelte-refresh-indicator":12,"./":2}],2:[function(require,module,exports){
...
const IndicatorDisplay = ({ indicator, distanceToRefresh, extraPullDistance, threshold }) => {
  ...
  const placeIndicator = (y, { smooth = false } = {}) => {
    ...
    setY(restingY + Math.min(y, maxY), indicator.node)
  }
...
},{"./lib/once":7,"./lib/overflow-top-scroll-drag":8}],3:[function(require,module,exports){
const on = require('./on')
...
},{"./on":6,"./once":7,"./pointer-down":9,"./pointer-move":10,"./pointer-up":11}],4:[function(require,module,exports){
...
},{"./objectify":5}],5:[function(require,module,exports){
...
},{"./on":6}],8:[function(require,module,exports){
const on = require('./on')
...
},{"./drag":3,"./on":6}],9:[function(require,module,exports){
const on = require('./on')
...
},{"./make-touch-event-like-mouse-event":4,"./on":6}],10:[function(require,module,exports){
const on = require('./on')
const makeLikeMouseEvent = require('./make-touch-event-like-mouse-event')
...
},{"./make-touch-event-like-mouse-event":4,"./on":6}],11:[function(require,module,exports){
const on = require('./on')
const makeLikeMouseEvent = require('./make-touch-event-like-mouse-event')
...
},{"./make-touch-event-like-mouse-event":4,"./on":6}],12:[function(require,module,exports){
'use strict';
